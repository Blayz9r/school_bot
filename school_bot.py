...
async def next_lesson(update, today):
    ...
    if schedule[tomorrow]:
        ...
        await update.message.reply_text(f"📅 Сьогодні уроків немає.\n⏭ *Завтра перший урок:* {t} – {name}", parse_mode="Markdown")
    else:
        await update.message.reply_text("🎉 Найближчих уроків немає")
